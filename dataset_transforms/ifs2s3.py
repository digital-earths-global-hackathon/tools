...
def add_crs(z, nside):
    crs = z.create_array(name="crs", dtype=np.float32, shape=(1,))
...
if sys.argv[1] == "2D_hourly_healpix128":
    ...
    zarr_in = zarr.open("reference::/work/bm1235/u233156/gribscan_cycle4_3999_RCBMF/gribscan_1h1d_2D_healpix128/jsons/sfc.dir/atm2d.json", mode="r")
    ...
    #dictzarr_more = {
    #"rldt": "0", # trivial
    #"rldscs": "",  # WE DON'T HAVE THIS
    #"huss": "", # dont have huss, have 2d instead
    #"tas": "2t",
    #"sncvfa": "",  # don't have it
    #}

    rechunk_dataset(zarr_in, zarr_out, chunks_per_dim, variables)
    ...
    zarr_in = zarr.open("reference::/work/bm1235/u233156/gribscan_cycle4_3999_RCBMF/gribscan_1h1d_2D_healpix128/jsons/pl.dir/atm3d.json", mode="r")
